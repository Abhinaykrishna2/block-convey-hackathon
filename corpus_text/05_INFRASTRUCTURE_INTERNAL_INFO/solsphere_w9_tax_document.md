# Solsphere W-9: scanned form transcription

- **Source path (repository-relative):** `Hackathon/5. Infrastructure_internal info/Solsphere W-9.pdf`
- **Source locator:** all 6 pages, rendered and visually inspected; page 1 contains entered fields and the start of general instructions; pages 2-6 continue generic IRS instructions.
- **Source format:** raster PDF with no extractable text returned by pypdf on any page. OCR assisted the transcription; visible fields and table associations were checked against the rendered pages. Line wrapping, bullets, and tables are normalized; this is not a certified character-for-character transcription.
- **Printed title:** Form W-9, Request for Taxpayer Identification Number and Certification.
- **Printed revision:** Rev. March 2024; Department of the Treasury, Internal Revenue Service.
- **Evidence status:** partially completed, visibly unsigned form. The source does not label itself a draft or template. Blank fields are recorded as blank, not as unreadable or redacted.

## Page 1: literal entered fields and checkbox observations

| Source locator | Visible value or state |
|---|---|
| Line 1, Name of entity/individual | `Solsphere AI Inc` |
| Line 2, Business name/disregarded entity name, if different from above | Blank |
| Line 3a, Individual/sole proprietor | Unchecked |
| Line 3a, C corporation | Checked |
| Line 3a, S corporation | Unchecked |
| Line 3a, Partnership | Unchecked |
| Line 3a, Trust/estate | Unchecked |
| Line 3a, LLC; tax-classification entry | Unchecked; entry blank |
| Line 3a, Other (see instructions); entry | Unchecked; entry blank |
| Line 3b, foreign partners/owners/beneficiaries checkbox | Unchecked |
| Line 4, Exempt payee code (if any) | Blank |
| Line 4, Exemption from FATCA reporting code (if any) | Blank |
| Line 5, Address (number, street, and apt. or suite no.) | Blank |
| Line 6, City, state, and ZIP code | `Dover, Delaware 19901` |
| Line 7, List account number(s) here (optional) | Blank |
| Requester's name and address (optional) | Blank |
| Part I, Social security number | Blank |
| Part I, Employer identification number | Blank |
| Part II, Signature of U.S. person | Blank; no visible signature |
| Part II, Date | Blank |

## Interpretation and limits (not source text)

The form displays the name, city/state/ZIP, and checked federal tax classification above. It does not establish incorporation jurisdiction, registered-office status, a verified EIN, signing authority, a DBA relationship, or completion of a tax certification. `Regodit` is not entered on this form. The blank signature/date fields support describing it as unsigned; they do not establish why it was left unsigned.

The following material is generic IRS form language and instructions printed in this supplied March 2024 revision. It is not additional company evidence or independently checked current tax guidance. Bracketed field-state descriptions above are editorial observations.

## Page 1: printed form language
...
Individual/sole proprietor; C corporation; S corporation; Partnership; Trust/estate; LLC; Other (see instructions).
...
[Sentence continues on page 2.]

Footer: Cat. No. 10231X; Form W-9 (Rev. 3-2024).

## Page 2: generic IRS instructions (OCR-assisted, visually reviewed)
...
## Page 3: generic IRS instructions (OCR-assisted, visually reviewed)
...
## Page 4: generic IRS instructions (OCR-assisted, visually reviewed)
...
## Page 5: generic IRS instructions (OCR-assisted, visually reviewed)
...
## Page 6: generic IRS instructions (OCR-assisted, visually reviewed)
