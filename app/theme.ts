...
.brand{font-size:19px;font-weight:700;letter-spacing:.15em;
...
.sub{color:var(--tx3);font-size:12.5px;margin-top:6px;letter-spacing:.01em}
.right{display:flex;align-items:center;gap:16px}
.counts{display:flex;gap:16px;font-size:11.5px;font-variant-numeric:tabular-nums;
  letter-spacing:.02em}
...
button,.navcta,.ghost,.primary{
  ...
  padding:9px 16px;border-radius:11px;font-size:13px;font-weight:500;cursor:pointer;
...
.primary.big{padding:15px 30px;font-size:15px;border-radius:12px}
...
.eyebrow{display:inline-flex;align-items:center;gap:8px;font-size:10.5px;
...
.hero h1 em{font-style:normal;
  ...
  -webkit-background-clip:text;background-clip:text;color:transparent}
.hero p{font-size:16.5px;line-height:1.72;color:var(--tx2);margin:0 0 34px;max-width:650px}
.ctas{display:flex;gap:12px;align-items:center;flex-wrap:wrap}
.ctas .primary,.ctas .ghost{padding:13px 22px;font-size:14.5px;border-radius:12px;min-height:46px}
.ctas .ghost{color:var(--tx);background:linear-gradient(170deg,#fffdf9,#f6efe4);
  border-color:#d8cbb8}
.promise{margin-top:38px;padding:15px 19px;border-radius:10px;font-size:13.5px;
...
.sources span{font-size:10.5px;text-transform:uppercase;letter-spacing:.14em;
  color:var(--tx3);margin-right:6px}
.pill{font-size:12px;padding:7px 14px;border-radius:99px;color:var(--tx2)}

/* ── status badge with glow ─────────────────────────────── */
.badge,.b{font-size:10px;text-transform:uppercase;letter-spacing:.09em;
...
.proofhead{font-size:10.5px;text-transform:uppercase;letter-spacing:.14em;
...
.cards p,.ans{font-size:14px;line-height:1.72;color:#3d362c;margin:14px 0 0}
.ans{font-size:14.5px;white-space:pre-wrap}

/* ── evidence chips ─────────────────────────────────────── */
.chips{display:flex;gap:7px;flex-wrap:wrap;margin-top:15px}
.chip{font-family:ui-monospace,SFMono-Regular,monospace;font-size:10px;padding:5px 10px;
...
.chip em{font-style:normal;text-transform:uppercase;font-size:9px;letter-spacing:.07em;
  font-weight:600}
.chip em:only-child{color:var(--acc2)}
.none{font-size:10.5px;color:var(--tx3);font-family:ui-monospace,monospace;font-style:italic}
.conf{font-size:11px;color:var(--tx3);margin-left:auto;font-variant-numeric:tabular-nums}
...
.step .num{font-family:ui-monospace,monospace;font-size:11px;letter-spacing:.14em;
...
.step h3{font-size:16px;margin:0 0 10px;letter-spacing:-.012em}
.step p{font-size:13.5px;line-height:1.72;color:var(--tx2);margin:0}
...
.starter{font-size:13px;padding:11px 16px;text-align:left;color:var(--tx2);
  border-radius:10px}
...
.you{font-size:17px;font-weight:650;margin-bottom:13px;letter-spacing:-.015em;
  padding-left:13px;border-left:2px solid rgba(154,91,50,.45)}
.thinking{display:flex;align-items:center;gap:5px;color:var(--acc2);font-size:12.5px;
...
aside h3{margin:0 0 15px;font-size:11px;text-transform:uppercase;letter-spacing:.13em;
...
.empty{font-size:12.5px;color:var(--tx3);line-height:1.65;margin:0}
.pcard{border-left:2px solid;padding:10px 0 10px 12px;margin-bottom:14px;
  box-shadow:-12px 0 26px -22px currentColor}
.pq{font-size:12.5px;font-weight:600;margin-bottom:4px;color:var(--tx)}
.pa{font-size:12px;color:var(--tx2);line-height:1.55;
  display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
.pm{font-size:9.5px;color:var(--tx3);margin-top:6px;font-family:ui-monospace,monospace;
  letter-spacing:.03em}
...
.mhead code{font-size:12px;color:var(--acc2);font-family:ui-monospace,monospace}
.src{margin:0;padding:19px;font-size:12.5px;line-height:1.8;white-space:pre-wrap;
...
.glog{padding:14px 16px;font-family:ui-monospace,SFMono-Regular,monospace;
  font-size:11.5px;line-height:1.9;max-height:220px;overflow:auto}
